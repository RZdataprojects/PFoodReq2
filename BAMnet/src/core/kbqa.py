...
class KBQA(object):
    ...
    def merge_kbqa_similarity_score(self, kbqa_score, similarity_distance,
                                ...
                                max_kbqa_score,
                                min_kbqa_score):
        """similarity_distance is Manhattan distance"""
        assert 0 <= similarity_score_ratio <= 1
        try:
            transformed_kbqa_score = (kbqa_score - min_kbqa_score) / (max_kbqa_score - min_kbqa_score)
        except:
            transformed_kbqa_score = (kbqa_score - min_kbqa_score) / (max_kbqa_score - min_kbqa_score + 0.00001)
        transformed_similarity_score = 1 - similarity_distance  # Manhattan distance is already in the range [0, 1]
